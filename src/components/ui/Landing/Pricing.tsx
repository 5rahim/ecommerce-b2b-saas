import { Badge, Box, chakra, Flex, Icon, Link, SimpleGrid, Stack, Text, useColorModeValue, useToken } from "@chakra-ui/react"
                        ...
                        <Flex direction="column">
                           ...
                           >
                              <Stack mb={5} spacing={4}>
                                 <Feature>50 products</Feature>
                                 <Feature>10 categories</Feature>
                                 <Feature>Up to 200 orders</Feature>
                                 <Feature>Some analytics</Feature>
                                 <Feature>Whatsapp notifications</Feature>
                                 <Feature>Online communication</Feature>
                              </Stack>
                              <Link
                                 w="full"
                                 display="inline-flex"
                        ...
                        <Flex direction="column">
                           ...
                           >
                              <Stack mb={5} spacing={4}>
                                 ...
                                 <Feature>Unlimited categories</Feature>
                                 <Feature>Unlimited orders</Feature>
                                 <Feature>Full analytics</Feature>
